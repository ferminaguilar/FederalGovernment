...
class RuntimeImportContext {
   ...
   *
   * @deprecated in entity_share:8.x-3.7 and is removed from entity_share:4.0.0.
   * Get the service directly instead. @see
   * https://www.drupal.org/project/entity_share/issues/3536388
   */
  public function getImportService(): ImportServiceInterface {
    @trigger_error('\Drupal\entity_share_client\RuntimeImportContext::getImportService() is deprecated in entity_share:8.x-3.7 and is removed from entity_share:4.0.0. Get the service directly instead. @see https://www.drupal.org/project/entity_share/issues/3536388', E_USER_DEPRECATED);
    return \Drupal::service('entity_share_client.import_service');
  }
   ...
   *
   * @deprecated in entity_share:8.x-3.7 and is removed from entity_share:4.0.0.
   * There is no replacement. @see
   * https://www.drupal.org/project/entity_share/issues/3536388
   */
  public function setImportService(ImportServiceInterface $importService): void {
    @trigger_error('\Drupal\entity_share_client\RuntimeImportContext::setImportService() is deprecated in entity_share:8.x-3.7 and is removed from entity_share:4.0.0. There is no replacement. @see https://www.drupal.org/project/entity_share/issues/3536388', E_USER_DEPRECATED);
  }
