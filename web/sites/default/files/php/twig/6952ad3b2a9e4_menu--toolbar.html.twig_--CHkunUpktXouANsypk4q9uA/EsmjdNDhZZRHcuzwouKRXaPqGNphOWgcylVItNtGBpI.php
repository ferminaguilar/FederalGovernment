...
$context["item"], "in_active_trail", [], "any", false, false, true, 45)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("menu-item--active-trail") : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/modules/toolbar/templates/menu--toolbar.html.twig", "/workspaces/FederalGovernment/web/core/modules/toolbar/templates/menu--toolbar.html.twig");
    }
